 ...
 * 
 */
public class MessageSingleItemInfo extends AbstractMessageItemInfo {
	private final Logger log = Logger.getLogger(CommonStaticFinalVars.CORE_LOG_NAME);

	private String itemName;
	private MessageSingleItemType itemType;
	...
	private static final MessageSingleItemTypeManger singleItemTypeManger = MessageSingleItemTypeManger
			.getInstance();
	 ...
	 */
	public MessageSingleItemInfo(String itemName, String itemTypeName,
	 ...
	 * @return 항목 타입
	 */
	public MessageSingleItemType getItemType() {
		return itemType;
	}
	...
	/**
	 * @see MessageSingleItemTypeManger
	 * @return 항목 타입 식별자
	 */
	...
	public MessageItemInfoType getMessageItemInfoType() {
		return MessageItemInfoType.SINGLE;
	}
