 ...
 *
 */
public class MessageSingleItemTypeManger {
	private final Logger log = Logger.getLogger(CommonStaticFinalVars.CORE_LOG_NAME);

	private String messageXSLStr = null;

	private final MessageSingleItemType[] singleItemTypes = MessageSingleItemType.values();
	...
	private static final class ItemTypeMangerHolder {
		static final MessageSingleItemTypeManger singleton = new MessageSingleItemTypeManger();
	}
	 ...
	 * @return 싱글턴 객체
	 */
	public static MessageSingleItemTypeManger getInstance() {
	 ...
	 */
	private MessageSingleItemTypeManger() {
	 ...
	 */
	public MessageSingleItemType getSingleItemType(int singleItemTypeID) {
	 ...
	 */
	public MessageSingleItemType getSingleItemType(String itemTypeName) throws UnknownItemTypeException {
		if (null == itemTypeName) {
