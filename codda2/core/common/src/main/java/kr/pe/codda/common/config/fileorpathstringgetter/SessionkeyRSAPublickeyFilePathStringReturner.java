...
/**
 * 세션키에 사용되는 RSA 공개키 파일 경로 전체 이름 반환자
 * @author Won Jonghoon
 *
 */
public class SessionkeyRSAPublickeyFilePathStringReturner extends AbstractFileOrPathStringReturner {
	/**
	 * 생성자
	 * @param itemID 항목 식별자
	 */
	public SessionkeyRSAPublickeyFilePathStringReturner(String itemID) {
		super(itemID);
	}
