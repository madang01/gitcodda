...
public class SbMemberActivityHistoryTbRecord extends UpdatableRecordImpl<SbMemberActivityHistoryTbRecord> implements Record6<String, UInteger, UByte, UInteger, Byte, Timestamp> {

    private static final long serialVersionUID = 975719472;
     ...
     */
    public void setActivitySq(UInteger value) {
        set(1, value);
    }
     ...
     */
    @Override
    public Row6<String, UInteger, UByte, UInteger, Byte, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row6<String, UInteger, UByte, UInteger, Byte, Timestamp> valuesRow() {
     ...
     */
    @Override
    public SbMemberActivityHistoryTbRecord value2(UInteger value) {
        setActivitySq(value);
        return this;
    }
     ...
     */
    @Override
    public SbMemberActivityHistoryTbRecord values(String value1, UInteger value2, UByte value3, UInteger value4, Byte value5, Timestamp value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SbMemberActivityHistoryTbRecord(String userId, UInteger activitySq, UByte boardId, UInteger boardNo, Byte activityType, Timestamp regDt) {
        super(SbMemberActivityHistoryTb.SB_MEMBER_ACTIVITY_HISTORY_TB);
