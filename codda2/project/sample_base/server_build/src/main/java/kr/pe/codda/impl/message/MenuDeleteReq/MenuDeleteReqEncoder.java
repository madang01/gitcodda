...
public final class MenuDeleteReqEncoder extends AbstractMessageEncoder {
	...
	public void encode(AbstractMessage messageObj, SingleItemEncoderIF singleItemEncoder, Object middleObjectToSend) throws Exception {
		...
		encodeBody(menuDeleteReq, singleItemEncoder, middleObjectToSend);
	}


	private void encodeBody(MenuDeleteReq menuDeleteReq, SingleItemEncoderIF singleItemEncoder, Object middleObjectToSend) throws Exception {
