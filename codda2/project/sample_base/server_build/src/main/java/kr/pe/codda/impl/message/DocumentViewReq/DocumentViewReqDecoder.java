...
/**
 * DocumentViewReq message decoder
 * @author Won Jonghoon
 *
 */
public final class DocumentViewReqDecoder extends AbstractMessageDecoder {
	...
	protected AbstractMessage decodeBody(SingleItemDecoderIF singleItemDecoder, Object receivedMiddleObject) throws BodyFormatException {
		...
		documentViewReq.setRequestedUserID((String)
		...
		documentViewReq.setDocumentNo((Long)
		singleItemDecoder.getValue(pathStack.peek()
			, "documentNo" // itemName
