...
public final class BoardModifyReqDecoder extends AbstractMessageDecoder {
	...
	protected AbstractMessage decodeBody(SingleItemDecoderIF singleItemDecoder, Object receivedMiddleObject) throws BodyFormatException {
		...
		Object oldAttachedFile$2ArrayMiddleObject = singleItemDecoder.getArrayMiddleObject(pathStack.peek(), "oldAttachedFile", oldAttachedFile$2ListSize, receivedMiddleObject);
		...
		for (int i2=0; i2 < oldAttachedFile$2ListSize; i2++) {
			...
			Object oldAttachedFile$2MiddleWritableObject= singleItemDecoder.getMiddleObjectFromArrayMiddleObject(pathStack.peek(), oldAttachedFile$2ArrayMiddleObject, i2);
