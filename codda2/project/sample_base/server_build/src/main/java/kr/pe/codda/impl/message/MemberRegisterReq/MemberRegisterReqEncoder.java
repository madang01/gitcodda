...
public final class MemberRegisterReqEncoder extends AbstractMessageEncoder {
	...
	public void encode(AbstractMessage messageObj, SingleItemEncoderIF singleItemEncoder, Object middleObjectToSend) throws Exception {
		...
		encodeBody(memberRegisterReq, singleItemEncoder, middleObjectToSend);
	}


	private void encodeBody(MemberRegisterReq memberRegisterReq, SingleItemEncoderIF singleItemEncoder, Object middleObjectToSend) throws Exception {
		...
		singleItemEncoder.putValue(pathStack.peek(), "nicknameCipherBase64"
			, kr.pe.codda.common.type.SingleItemType.SI_PASCAL_STRING // itemType
