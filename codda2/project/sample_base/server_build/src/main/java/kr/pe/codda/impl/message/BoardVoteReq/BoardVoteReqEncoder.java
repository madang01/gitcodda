...
public final class BoardVoteReqEncoder extends AbstractMessageEncoder {
	...
	public void encode(AbstractMessage messageObj, SingleItemEncoderIF singleItemEncoder, Object middleObjectToSend) throws Exception {
		...
		encodeBody(boardVoteReq, singleItemEncoder, middleObjectToSend);
	}


	private void encodeBody(BoardVoteReq boardVoteReq, SingleItemEncoderIF singleItemEncoder, Object middleObjectToSend) throws Exception {
