...
/**
 * DocumentModifyReq message decoder
 * @author Won Jonghoon
 *
 */
public final class DocumentModifyReqDecoder extends AbstractMessageDecoder {
	...
	protected AbstractMessage decodeBody(SingleItemDecoderIF singleItemDecoder, Object receivedMiddleObject) throws BodyFormatException {
		...
		documentModifyReq.setRequestedUserID((String)
		...
		documentModifyReq.setIp((String)
		singleItemDecoder.getValue(pathStack.peek()
			, "ip" // itemName
			, kr.pe.codda.common.type.SingleItemType.UB_PASCAL_STRING // itemType
			, -1 // itemSize
		...
		documentModifyReq.setDocumentNo((Long)
		singleItemDecoder.getValue(pathStack.peek()
			, "documentNo" // itemName
		...
		documentModifyReq.setFileName((String)
		singleItemDecoder.getValue(pathStack.peek()
			, "fileName" // itemName
			, kr.pe.codda.common.type.SingleItemType.UB_PASCAL_STRING // itemType
			, -1 // itemSize
		...
		documentModifyReq.setSubject((String)
		singleItemDecoder.getValue(pathStack.peek()
			, "subject" // itemName
		...
		documentModifyReq.setContents((String)
		singleItemDecoder.getValue(pathStack.peek()
			, "contents" // itemName
