...
public class MemberLoginReqServerTaskTest extends AbstractBoardTest {
	...
	public void 회원로그인_미존재아이디() {
		...
		try {
			clientSessionKey = clientSessionKeyManager.createNewClientSessionKey(serverSessionkeyManager.getMainProjectServerSessionkey().getDupPublicKeyBytes(), false);
