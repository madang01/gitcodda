...
public class DocumentRegistrationProcessSvl extends AbstractMultipartServlet implements ImageFileURLGetterIF {
	...
	public BoardWriteRes doWork(HttpServletRequest req, HttpServletResponse res)
		...
		short boardID = WebCommonStaticFinalVars.DOCUMENT_MANAGER_BOARD_ID;
