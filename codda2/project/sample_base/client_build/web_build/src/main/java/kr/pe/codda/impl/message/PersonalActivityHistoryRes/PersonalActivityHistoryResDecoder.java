...
public final class PersonalActivityHistoryResDecoder extends AbstractMessageDecoder {
	...
	protected AbstractMessage decodeBody(SingleItemDecoderIF singleItemDecoder, Object receivedMiddleObject) throws BodyFormatException {
		...
		Object personalActivity$2ArrayMiddleObject = singleItemDecoder.getArrayMiddleObject(pathStack.peek(), "personalActivity", personalActivity$2ListSize, receivedMiddleObject);
		...
		for (int i2=0; i2 < personalActivity$2ListSize; i2++) {
			...
			Object personalActivity$2MiddleWritableObject= singleItemDecoder.getMiddleObjectFromArrayMiddleObject(pathStack.peek(), personalActivity$2ArrayMiddleObject, i2);
