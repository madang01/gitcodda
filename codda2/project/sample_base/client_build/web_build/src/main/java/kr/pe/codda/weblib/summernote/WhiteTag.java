...
public class WhiteTag {
	 ...
	 * @param attributeWhiteValueChecker 허락된 속성 값 검사기
	 * @throws IllegalArgumentException 속성 이름이  null 인 경우 혹은 '속성 값에 대한 허락된 문자 검사기' 가 null 인 경우 던지는 예외
	 * @throws WhiteParserException '허락된 속성 값 검사기' 의 태그와 속성값이 불일치 할 경우 던지는 예외
	 */
