...
public class JSSymmetricKeyProcessSvl extends AbstractServlet {
	...
	protected void performTask(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		final Hashtable<String, String> symmetricKeyTransformationHash = new Hashtable<String, String>();
		...
		try {
			...
			String debugMessage = new StringBuilder("paramAlgorithm=[").append(paramAlgorithm)
					.append("], paramPrivateKeyHex=").append(paramPrivateKeyHex).append("], paramIVHex=[")
					.append(paramIVHex).append("], errmsg=").append(e.getMessage()).toString();
			printErrorMessagePage(req, res, errorMessage, debugMessage);
			return;
		...
		try {
			...
			log.log(Level.WARNING, "IllegalBlockSizeException", e);
			throw new RuntimeException("IllegalBlockSizeException");
		} catch (BadPaddingException e) {
			log.log(Level.WARNING, "BadPaddingException", e);
		...
		/*
		{
			...
			logHash.put("plainHexText", plainHexText);
			logHash.put("decryptedHexText", decryptedHexText);
