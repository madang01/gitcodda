...
public final class BoardReplyResEncoder extends AbstractMessageEncoder {
	...
	public void encode(AbstractMessage messageObj, SingleItemEncoderIF singleItemEncoder, Object middleObjectToSend) throws Exception {
		...
		encodeBody(boardReplyRes, singleItemEncoder, middleObjectToSend);
	}


	private void encodeBody(BoardReplyRes boardReplyRes, SingleItemEncoderIF singleItemEncoder, Object middleObjectToSend) throws Exception {
