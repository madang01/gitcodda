...
public final class BoardWriteResEncoder extends AbstractMessageEncoder {
	...
	public void encode(AbstractMessage messageObj, SingleItemEncoderIF singleItemEncoder, Object middleObjectToSend) throws Exception {
		...
		encodeBody(boardWriteRes, singleItemEncoder, middleObjectToSend);
	}


	private void encodeBody(BoardWriteRes boardWriteRes, SingleItemEncoderIF singleItemEncoder, Object middleObjectToSend) throws Exception {
