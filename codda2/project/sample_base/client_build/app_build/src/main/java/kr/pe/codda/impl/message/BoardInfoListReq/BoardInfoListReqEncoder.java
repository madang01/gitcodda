...
public final class BoardInfoListReqEncoder extends AbstractMessageEncoder {
	...
	public void encode(AbstractMessage messageObj, SingleItemEncoderIF singleItemEncoder, Object middleObjectToSend) throws Exception {
		...
		encodeBody(boardInfoListReq, singleItemEncoder, middleObjectToSend);
	}


	private void encodeBody(BoardInfoListReq boardInfoListReq, SingleItemEncoderIF singleItemEncoder, Object middleObjectToSend) throws Exception {
